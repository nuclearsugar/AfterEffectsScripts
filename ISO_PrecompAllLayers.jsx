...
// Date: March 12, 2026
// Description: This After Effects script will precomp all layers within the comp and then put them into a single precomp. It will then move the newly created precomp into a folder named "Precomped via script". This operation will be executed for the selected comps in the Project window. Since all layers are precomped into a single comp, only the "Pre-compose: move all attributes into the new composition" technique can be utilized and the "Leave all attributes in <comp name>" technique is not possible.
