// ISO_PrecompAllSelectedComps.jsx
// Artist: https://www.jasonfletcher.info/
// Code generated by ChatGPT-5.3
// Date: March 12, 2026
// Description: This After Effects script will precomp all layers into a single precomp and move the newly created precomp into a folder named "Precomped via script". This operation will be executed for the selected comps in the Project window. This technique differs from the built-in "Pre-compose: move all attributes into the new composition" tool since this technique is entirely automated.
