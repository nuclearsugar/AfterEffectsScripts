...
## Script Usage
To run a JSX script in After Effects...
...
- Isosceles_WorkAreaStartToSpecificFrame.jsx - Moves the "Work Area Start" to a user-defined frame for all selected comps in the Project window.
