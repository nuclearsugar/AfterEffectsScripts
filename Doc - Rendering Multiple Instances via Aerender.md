...
- **Possibility 3:** If you're rendering for more than 24 hours, the AE render engine will gradually slow down over long uninterrupted renders. After 48 hours of continous rendering, I frequently see the per-frame render times slow down by a factor of two and yet I know that the complexity of the comps is consistent. So by reloading the whole AE render engine every so often, it will maintain consistent performance and avoid slow downs.
