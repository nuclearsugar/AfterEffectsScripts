...
// Date: June 11, 2026
// Description: This After Effects script opens the selected comps in the Project window and moves the Current Time Indicator to a user-specified timecode (H:MM:SS:FF).
